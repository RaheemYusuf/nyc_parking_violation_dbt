SELECT violations.summons_number, violations.registration_state, violations.plate_type,
    violations.issue_date, violations.violation_code, violations.vehicle_body_type,
    violations.vehicle_make, violations.issuing_agency,
    violations.vehicle_expiration_date, violations.violation_location,
